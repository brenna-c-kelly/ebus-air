...
o3_df_clean$day_of_week_label <- wday(o3_df_clean$date_time, label = TRUE)
# weekend
...
The median adjustment is -1.46 (IQR [-5.44, 1.94]), meaning in a typical scenario in this dataset, the mobile observations overestimated O3 by about 1.5 ppb. Adjustment values also ranged from -80.7 to 144.8 — substantial over- and underestimates, respectively.
