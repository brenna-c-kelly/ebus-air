...
o3_df_clean <- o3_df_clean |>
  ...
  mutate(day_of_week = wday(date_time, week_start = 7, # start week with Sunday
                            label = TRUE)) |>
...
# on average, we overestimate O3 more during days without exceptions
# i.e., mobile O3 is better than expected on fire days and outlier days
